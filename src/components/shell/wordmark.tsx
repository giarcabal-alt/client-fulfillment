...
export function Wordmark() {
  return (
    <Link
      ...
      className="mb-4 flex w-fit items-center gap-2 rounded-md outline-none transition-opacity hover:opacity-80 focus-visible:ring-3 focus-visible:ring-ring/50"
    >
